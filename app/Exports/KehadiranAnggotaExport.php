...
class KehadiranAnggotaExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnWidths, ShouldAutoSize
{
    ...
    {
        return ['No', 'Nama Anggota', 'Ekskul', 'Hadir', 'Izin', 'Sakit', 'Alpa', 'Total', '% Hadir'];
    }
