...
<!-- ===== HERO SECTION - Biru Cerah + Avatar ===== -->
<div class="hero-section hero-gradient mb-4" style="border-radius: 24px; padding: 32px 40px; position: relative; overflow: hidden; box-shadow: 0 8px 40px rgba(14,165,233,0.25);">
    ...
    <div class="col-md-3">
        <div class="stat-card-modern" style="background: #ffffff; border-radius: 20px; padding: 22px 24px; border: 1px solid rgba(0,0,0,0.03); box-shadow: 0 2px 12px rgba(0,0,0,0.03); transition: all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94); position: relative; overflow: hidden;">
            <div class="d-flex align-items-center gap-4">
                ...
                <div style="flex: 1;">
                    <span class="stat-label-modern" style="display: block; font-size: 11px; color: #64748b; font-weight: 500; text-transform: uppercase; letter-spacing: 0.5px;">Persentase Kehadiran</span>
    ...
    <div class="col-md-3">
        <div class="stat-card-modern" style="background: #ffffff; border-radius: 20px; padding: 22px 24px; border: 1px solid rgba(0,0,0,0.03); box-shadow: 0 2px 12px rgba(0,0,0,0.03); transition: all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94); position: relative; overflow: hidden;">
            <div class="d-flex align-items-center gap-4">
                ...
                <div style="flex: 1;">
                    <span class="stat-label-modern" style="display: block; font-size: 11px; color: #64748b; font-weight: 500; text-transform: uppercase; letter-spacing: 0.5px;">Ekskul</span>
                    <div style="margin: 0; letter-spacing: -0.5px; word-break: break-word; display: flex; flex-wrap: wrap; gap: 6px; margin-top: 6px;">
                        @forelse($data['ekskuls'] ?? collect() as $eskul)
                            <span style="display: inline-block; font-size: 11px; font-weight: 700; color: #0ea5e9; background: rgba(14,165,233,0.08); padding: 4px 10px; border-radius: 10px;">{{ $eskul->nama_ekskul }}</span>
                        @empty
    ...
    <div class="card-header premium-card-header" style="padding: 18px 24px; border-bottom: 1px solid rgba(0,0,0,0.03); display: flex; justify-content: space-between; align-items: center; background: rgba(248,250,252,0.2);">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <small class="text-muted" style="font-size: 12px; color: #64748b;">5 kehadiran terakhir</small>
            </div>
        </div>
                    ...
                    <tr style="transition: all 0.3s ease; animation: fadeRow 0.5s ease forwards;">
                        ...
                        <td style="padding: 12px 16px; border-bottom: 1px solid rgba(0,0,0,0.015); vertical-align: middle;">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-icon" style="width: 28px; height: 28px; border-radius: 50%; background: rgba(16,185,129,0.08); display: flex; align-items: center; justify-content: center; color: #10b981; font-size: 12px; flex-shrink: 0;">
                                    <i class="fas fa-trophy"></i>
                                </div>
                                <span class="fw-semibold" style="color: #0f172a; font-size: 12.5px;">{{ $item->ekskul->nama_ekskul ?? '-' }}</span>
                            </div>
                        </td>
                        <td style="padding: 12px 16px; border-bottom: 1px solid rgba(0,0,0,0.015); vertical-align: middle;">
