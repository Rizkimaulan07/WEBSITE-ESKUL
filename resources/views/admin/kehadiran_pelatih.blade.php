...
<div class="card-modern mb-4">
    <div class="card-header-modern">
        <div class="d-flex justify-content-between align-items-center w-100 flex-wrap gap-2">
            <h6><i class="fas fa-user-check me-2" style="color: #6366f1;"></i>Rekap Bulanan Kehadiran Pelatih</h6>
        ...
        <div class="table-responsive">
            <table class="table-modern">
                <thead>
                    <tr>
                        <th width="5%">No</th>
                        <th width="22%">Nama Pelatih</th>
                        <th width="18%">Ekskul</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="avatar-circle">{{ strtoupper(substr($rekap['pelatih']->name ?? 'P', 0, 1)) }}</div>
                                    <div>
                                        <div class="fw-semibold">{{ $rekap['pelatih']->name ?? '-' }}</div>
                                    </div>
                                </div>
                            </td>
...
<div class="card-modern">
    <div class="card-header-modern">
        <div class="d-flex justify-content-between align-items-center w-100 flex-wrap gap-2">
            <h6><i class="fas fa-list me-2" style="color: #6366f1;"></i>Detail Kehadiran Pelatih</h6>
                ...
                <tbody>
                    @forelse($kehadiran as $index => $item)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="avatar-circle">{{ strtoupper(substr($item->pelatih->name ?? 'P', 0, 1)) }}</div>
                                    <div>
                                        <div class="fw-semibold">{{ $item->pelatih->name ?? '-' }}</div>
                                    </div>
                                </div>
                            </td>
