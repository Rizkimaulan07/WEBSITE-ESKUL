    ...
    <div class="col-xl-3 col-lg-6 col-md-6">
        <div class="stat-card" style="--accent: #3b82f6; --glow: rgba(59,130,246,0.15);">
            ...
            <div class="stat-body">
                ...
                <h3 class="stat-number">{{ $ekskuls->count() ?? 0 }}</h3>
                <span class="stat-trend up">
        ...
        <div class="row g-3 align-items-center">
            <div class="col-md-5">
                <div class="search-wrapper">
                    ...
                    <input type="text" class="search-input" placeholder="Cari anggota berdasarkan nama, email, atau kelas..." id="searchInput">
                </div>
            </div>
            <div class="col-md-7">
                <div class="d-flex flex-wrap gap-2 justify-content-md-end">
                    ...
                    <a href="{{ route('admin.anggota.create') }}" class="btn-primary-gradient">
...
<div class="card premium-table-card">
    <div class="card-header premium-table-header">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <small class="text-muted">{{ $anggotas->total() }} total data</small>
            </div>
        </div>
        <div>
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table premium-table" id="anggotaTable">
                <thead>
                    <tr>
                        <th width="5%">#</th>
                ...
                <tbody>
                    ...
                    <tr class="table-row" data-ekskul="{{ $anggota->ekskul_id ?? '' }}" data-kelas="{{ $anggota->kelas ?? '' }}">
                        <td>
                        ...
                        <td>
                            <div class="user-name">
                                <span class="fw-bold">{{ $anggota->name }}</span>
                                <span class="user-id">ID: {{ $anggota->id }}</span>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <span class="badge-kelas">{{ $anggota->kelas ?? '-' }}</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="8">
                            <div class="empty-state">
                                ...
                                <p class="empty-desc">Tambahkan anggota pertama Anda</p>
                                <a href="{{ route('admin.anggota.create') }}" class="btn-primary-gradient mt-3">
                                    <i class="fas fa-user-plus me-2"></i> Tambah Anggota
                                </a>
                            </div>
                        </td>
...
<style>
    ...
    .user-name .fw-bold { font-weight: 700; color: #0f172a; font-size: 14px; }
    .user-name .user-id { font-size: 11px; color: #94a3b8; }

    .user-email { font-size: 13px; color: #475569; }
    .user-phone { font-size: 13px; color: #475569; }
