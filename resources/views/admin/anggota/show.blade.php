        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-between">
                    <span class="text-muted small" style="color: #64748b; font-size: 12px;">ID Anggota</span>
            ...
            <div class="card-footer bg-transparent border-0 pt-0 px-4 pb-4">
                <div class="d-grid gap-2">
                    <a href="{{ route('admin.anggota.edit', $anggota->id) }}" class="btn-edit btn-primary-gradient" style="display: block; width: 100%; padding: 12px; font-weight: 600; font-size: 14px; text-align: center; text-decoration: none; transition: all 0.3s ease;">
                            ...
                            <div class="col-12">
                                ...
                                @else
                                    <div class="text-center py-3">
                                        ...
                                        <span class="text-muted" style="color: #64748b;">Belum bergabung dengan ekskul manapun</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="stat-mini blue" style="display: flex; align-items: center; gap: 14px; padding: 14px 18px; background: #f8fafc; border-radius: 12px; border: 1px solid rgba(0,0,0,0.02); transition: all 0.3s ease;">
                                    ...
                                    <div>
                                        <div class="stat-mini-label" style="font-size: 11px; color: #64748b; font-weight: 500;">Total Kehadiran</div>
                            ...
                            <div class="col-md-4">
                                <div class="stat-mini gold" style="display: flex; align-items: center; gap: 14px; padding: 14px 18px; background: #f8fafc; border-radius: 12px; border: 1px solid rgba(0,0,0,0.02); transition: all 0.3s ease;">
                                    ...
                                    <div>
                                        <div class="stat-mini-label" style="font-size: 11px; color: #64748b; font-weight: 500;">Rata-rata Nilai</div>
                            ...
                            <div class="col-md-4">
                                <div class="stat-mini green" style="display: flex; align-items: center; gap: 14px; padding: 14px 18px; background: #f8fafc; border-radius: 12px; border: 1px solid rgba(0,0,0,0.02); transition: all 0.3s ease;">
                                    ...
                                    <div>
                                        <div class="stat-mini-label" style="font-size: 11px; color: #64748b; font-weight: 500;">Persentase Kehadiran</div>
                                        <div class="stat-mini-value" style="font-size: 18px; font-weight: 700; color: #0f172a; line-height: 1.2;">0%</div>
                                    </div>
                                </div>
                            </div>
