...
@section('subtitle', 'Rekap kehadiran anggota di semua ekskul')
    ...
    <div class="card-header border-0 py-4 px-5 hero-gradient">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div class="d-flex align-items-center gap-4">
                ...
                <div>
                    <h4 class="text-white fw-bold mb-0" style="font-size: 22px; letter-spacing: -0.5px;">{{ $titleText }} Kehadiran Anggota</h4>
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap">
                <a href="{{ route('admin.kehadiran_anggota.export', $filterParams) }}" class="btn" style="background: #10b981; border: none; color: #fff; font-weight: 600; padding: 10px 20px; border-radius: 10px; box-shadow: 0 4px 16px rgba(16,185,129,0.3);">
...
<div class="card-modern mb-4">
    <div class="card-body-modern">
        <form method="GET" action="{{ route('admin.kehadiran_anggota') }}" id="filterForm">
            <div class="filter-container">
                <div class="filter-row">
                    ...
                    <div class="filter-group" style="flex: 0 0 180px;">
                        <label>Ekskul</label>
                        <select name="eskul_id" id="ekskulInput" class="filter-input">
                            <option value="">Semua Ekskul</option>
                            @foreach($allEkskuls as $e)
                                <option value="{{ $e->id }}" {{ ($ekskulFilter ?? '') == $e->id ? 'selected' : '' }}>{{ $e->nama_ekskul }}</option>
                            @endforeach
                        </select>
                    </div>
    ...
    <div class="card-body-modern">
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <h5 class="fw-bold mb-0" style="color: #0f172a;">
                <i class="fas fa-list-ul me-2" style="color: #0ea5e9;"></i>Rekap Kehadiran Anggota
            </h5>
