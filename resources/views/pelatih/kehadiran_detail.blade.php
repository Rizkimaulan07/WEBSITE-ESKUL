            ...
            <div class="card-body p-5">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="info-card" style="padding: 16px 20px; background: #f8fafc; border-radius: 12px; border: 1px solid rgba(0,0,0,0.02); transition: all 0.3s ease; height: 100%;">
                            <div class="info-label" style="font-size: 11px; color: #64748b; font-weight: 500; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 6px;">
                            ...
                            <div class="info-sub text-muted" style="color: #64748b; font-size: 12px;">
                ...
                <div class="mt-4 pt-3 border-top" style="border-color: #e2e8f0;">
                    <div class="d-flex gap-3 justify-content-between flex-wrap">
                        <a href="{{ route('pelatih.kehadiran') }}" class="btn-secondary-custom" style="padding: 12px 32px;">
