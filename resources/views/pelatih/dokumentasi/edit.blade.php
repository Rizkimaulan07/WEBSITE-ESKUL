    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden" style="background: #ffffff;">
            ...
            <div class="card-body p-5">
                <form action="{{ route('pelatih.dokumentasi.update', $dokumentasi->id) }}" method="POST" enctype="multipart/form-data" id="dokumentasiEditForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="form-group-modern">
                                ...
                                <input type="text" class="form-control form-control-modern" value="{{ $dokumentasi->ekskul->nama_ekskul ?? '-' }}" disabled>
                            </div>
                        </div>
                                ...
                                @if($dokumentasi->foto_path)
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-2 flex-wrap">
                                            <img src="{{ asset('storage/' . App\Models\Dokumentasi::normalizeFotoPath($dokumentasi->foto_path)) }}" 
                                                 alt="Foto utama" class="rounded-3" 
                                                 style="width: 90px; height: 90px; object-fit: cover; border: 2px solid #40a7ff;">
