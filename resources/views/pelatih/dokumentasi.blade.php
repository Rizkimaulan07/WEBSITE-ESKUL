        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden hover-card" style="background: #ffffff; transition: all 0.3s ease;">
            <div class="position-relative">
                @if($item->foto_path)
                    ...
                    @else
                        <div class="bg-light d-flex flex-column align-items-center justify-content-center" 
                            ...
                            <i class="fas fa-image fa-4x text-muted mb-2" style="color: #64748b;"></i>
                            <small class="text-muted" style="color: #64748b;">Gambar tidak ditemukan</small>
                        </div>
                    @endif
                @else
                    <div class="bg-light d-flex align-items-center justify-content-center" 
                         style="height: 220px; background: #f8fafc;">
                        <i class="fas fa-image fa-4x text-muted" style="color: #64748b;"></i>
                    </div>
                @endif
                ...
                <div class="position-absolute bottom-0 end-0 p-2 d-flex gap-2">
                    <a href="{{ route('pelatih.dokumentasi.edit', $item->id) }}" class="btn btn-sm rounded-circle" 
                       style="width: 32px; height: 32px; padding: 0; display: flex; align-items: center; justify-content: center; background: rgba(14,165,233,0.9); border: none; transition: all 0.3s ease;"
            ...
            <div class="card-body" style="padding: 16px;">
                ...
                <p class="text-muted small mb-2" style="color: #64748b; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
        ...
        <div class="card border-0 shadow-sm rounded-4" style="background: #ffffff;">
            <div class="card-body text-center py-5">
                <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center mb-3" 
                    ...
                    <i class="fas fa-images fa-4x text-muted" style="color: #64748b;"></i>
                </div>
                <h5 class="text-muted mb-2" style="color: #64748b;">Belum ada dokumentasi</h5>
                <p class="text-muted small" style="color: #64748b;">Mulai tambahkan dokumentasi kegiatan Anda</p>
                <a href="{{ route('pelatih.dokumentasi.create') }}" class="btn btn-primary rounded-pill mt-3 px-5 btn-primary-gradient">
                    <i class="fas fa-plus me-2"></i>Tambah Dokumentasi
                </a>
            </div>
        </div>
