...
<form method="POST" action="{{ route('register') }}">
        ...
        <div class="col-12">
            <div class="form-group" style="margin-bottom: 16px;">
                ...
                <div class="input-wrapper" style="position: relative;">
                    ...
                    <i class="fas fa-user input-icon" style="position: absolute; left: 16px; top: 50%; transform: translateY(-50%); color: #64748b; font-size: 16px;"></i>
                    @error('name')
            ...
            <div class="form-group" style="margin-bottom: 16px;">
                ...
                <div class="input-wrapper" style="position: relative;">
                    <input type="email" 
                           ...
                           required
                           style="width: 100%; padding: 14px 16px 14px 48px; border: 2px solid #e5e7eb; border-radius: 14px; font-size: 14px; font-family: 'Inter', sans-serif; background: #f8fafc; color: #0f172a; transition: all 0.3s ease;">
                    <i class="fas fa-envelope input-icon" style="position: absolute; left: 16px; top: 50%; transform: translateY(-50%); color: #64748b; font-size: 16px;"></i>
                    @error('email')
                        <small class="text-danger" style="color: #dc2626; font-size: 13px; display: block; margin-top: 4px;">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="form-group" style="margin-bottom: 16px;">
                ...
                <div class="input-wrapper" style="position: relative;">
                    <input type="password" 
                           ...
                           required
                           style="width: 100%; padding: 14px 16px 14px 48px; border: 2px solid #e5e7eb; border-radius: 14px; font-size: 14px; font-family: 'Inter', sans-serif; background: #f8fafc; color: #0f172a; transition: all 0.3s ease;">
                    <i class="fas fa-lock input-icon" style="position: absolute; left: 16px; top: 50%; transform: translateY(-50%); color: #64748b; font-size: 16px;"></i>
            ...
            <div class="form-group" style="margin-bottom: 16px;">
                ...
                <div class="input-wrapper" style="position: relative;">
                    <input type="password" 
                           ...
                           required
                           style="width: 100%; padding: 14px 16px 14px 48px; border: 2px solid #e5e7eb; border-radius: 14px; font-size: 14px; font-family: 'Inter', sans-serif; background: #f8fafc; color: #0f172a; transition: all 0.3s ease;">
                    <i class="fas fa-circle-check input-icon" style="position: absolute; left: 16px; top: 50%; transform: translateY(-50%); color: #64748b; font-size: 16px;"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <button type="submit" class="btn-auth mt-3" style="width: 100%; padding: 16px; border: none; border-radius: 14px; background: linear-gradient(135deg, #0ea5e9, #38bdf8); color: #fff; font-size: 15px; font-weight: 600; font-family: 'Inter', sans-serif; transition: all 0.4s cubic-bezier(0.34, 1.56, 0.64, 1); cursor: pointer; box-shadow: 0 4px 24px rgba(14,165,233,0.25);">
        <span class="btn-text">Daftar <i class="fas fa-arrow-right ms-2"></i></span>
